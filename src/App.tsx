      ...
      <main className="App-content">
        <FormProvider>
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                producto "Cuenta Corriente OpenClose" y explicarle que vas a
                demandarle sus datos en los siguientes pasos. Es una pantalla
                con una explicación, nombre del producto y botones de wizard de
                avanzar.
              </p>
              <h5>
                Esta pantalla será el paso numero uno del wizard y tiene que
                tener un check (que tiene que pulsar) que habilite el boton de
                avanzar, en el que se le pregunta al usuario si tiene mayoría de
            ...
            <li>
              ...
              <h5>
                Aquí para poder avanzar de paso, es necesario que todos los
                campos del formulario esten correctamente rellenos. Se debe
                controlar errores de tipo o forma en cada uno de ellos,
            ...
            <li>
              ...
              <Step3 />
              <p>
                Esta pantalla unicamente mostrará un icono de Ok/Ko informando
                al usuario del resultado, además de un boton que reinicie el
                proceso.
              </p>
              <p>
                Se provee de un mock en el services/api desde el cual se puede
                imitar el comportamiento de una llamada asíncrona. (Checkear
                para ver caso de error)
              </p>
              <h5>
                Debe ser una pantalla que cumpla cualquier de los requisitos,
          ...
          <p>
            ...
            libre disposición para que el destinatario lo use o no si lo cree
            conveniente.
          </p>
          <h3>Duración</h3>
          <p>
            No hay una estimación directa ni concreta de la prueba, pero
            queremos marcar como máximo 1 semana(7 días naturales) desde el
            recibo de la misma.
          </p>
