    ...
    <div className="App">
      <main className="App-content">
        ...
        <p>
          ...
          como arquitectura, uso de patrones de diseño, maquetación, técnicas de
        ...
        <p>
          ...
          contraseña para un usuario. Lo que queremos que hagas es que plantees
          un wizard de unos 3 pasos en los que un usuario reciba información de
          que está a punto de crear una contraseña nueva, un formulario donde se
          le pidan una serie de datos para la creación de la contraseña y una
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              demandarle sus datos en los siguientes pasos. Es una pantalla con
              una explicación, nombre del producto y botones de wizard de
              avanzar.
            </p>
            <h5>
              Esta pantalla será el paso numero uno del wizard y tiene que tener
              un check (que tiene que pulsar) que habilite el boton de avanzar,
              en el que se le pregunta al usuario si tiene mayoría de edad y que
